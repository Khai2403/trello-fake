...
v-dialog.rounded-lg(v-model='isAddMember', :max-width='450', persistent='')
    AddMemberModal(@close-add-member='isAddMember = false', :board="board", @status="handleStatus")
v-dialog.rounded-lg(v-model='isDeleteMember', :max-width='450', persistent='')
    DeleteMemberModal(@close-delete-member='isDeleteMember = false', :board="board", @status="handleStatus")
...
<script setup>
import AddMemberModal from '../features/sidebar/AddMemberModal.vue';
import DeleteMemberModal from '../features/sidebar/DeleteMemberModal.vue';
